...
public class MechanicNothing extends CustomCard {
    public final static String ID = makeID("MechanicNothing");
    public final static String ImageID = makeID("TheMechanic");
    protected final CardStrings cardStrings;

    public MechanicNothing() {
