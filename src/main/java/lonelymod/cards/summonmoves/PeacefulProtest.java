...
public class PeacefulProtest extends CustomCard {
    public final static String ID = makeID("PeacefulProtest");
    public final static String ImageID = makeID("TheOracle");
    protected final CardStrings cardStrings;

    public PeacefulProtest() {
