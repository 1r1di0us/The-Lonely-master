...
public class Bones extends AbstractCompanion {
    ...
    public void takeTurn() {
        switch (this.nextMove) {
            case DEFAULT:
                addToBot(new GainBlockAction(AbstractDungeon.player, this, defaultBlk));
                break;
            case ATTACK:
                ...
                break;
            case PROTECT:
                addToBot(new GainBlockAction(AbstractDungeon.player, this, protectBlk));
    ...
    public void updateIntentTip() {
        switch (nextMove) {
            case DEFAULT:
                ...
                this.intentTip.body = TEXT[1] + this.defaultBlk + TEXT[2];
            ...
            case PROTECT:
                ...
                this.intentTip.body = TEXT[8] + this.protectBlk + TEXT[9] + PROTECT_PWR_AMT + TEXT[10];
