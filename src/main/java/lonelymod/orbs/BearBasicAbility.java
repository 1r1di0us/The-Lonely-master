...
public class BearBasicAbility extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = makeID("BearBasicAbility");
