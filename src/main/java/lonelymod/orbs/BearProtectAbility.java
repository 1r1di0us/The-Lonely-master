...
public class BearProtectAbility extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = makeID("BearProtectAbility");
    private static final OrbStrings orbString = CardCrawlGame.languagePack.getOrbString(ORB_ID);
    public static final String[] DESCRIPTIONS = orbString.DESCRIPTION;

    private static final int PASSIVE_AMOUNT = 4;
    private static final int EVOKE_AMOUNT = 0;
    private static final int blockTimes = 3;
    ...
    public void onEvoke() { // 1.On Orb Evoke
        AbstractDungeon.actionManager.addToBottom(new SFXAction("SLIME_BLINK_2")); // 1. Play a Jingle Sound. Because why not
    }
    ...
    public void playChannelSFX() { // When you channel this orb, the GREMLINFAT sound plays.
        CardCrawlGame.sound.play("VO_GIANTHEAD_1C", 0.4f);
    }

    @Override
    public AbstractOrb makeCopy() {
        return new BearProtectAbility();
    }
}
