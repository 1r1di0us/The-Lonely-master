...
public class SquirrelProtectAbility extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = makeID("SquirrelProtectAbility");
    ...
    public void playChannelSFX() { // When you channel this orb, the GREMLINFAT sound plays.
        CardCrawlGame.sound.play("VO_GREMLINFAT_1C", -0.5f);
    }

    @Override
    public AbstractOrb makeCopy() {
        return new SquirrelProtectAbility();
    }
}
