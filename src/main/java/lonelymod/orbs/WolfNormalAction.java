...
public class WolfNormalAction extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = makeID("WolfNormalAction");
    ...
    public void onEvoke() { // 1.On Orb Evoke
        ...
        AbstractDungeon.actionManager.addToBottom(new SFXAction("TINGSHA")); // 1. Play a Jingle Sound. Because why not
