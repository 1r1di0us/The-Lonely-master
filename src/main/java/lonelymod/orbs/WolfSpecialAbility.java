...
public class WolfSpecialAbility extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = makeID("WolfSpecialAbility");
    ...
    public void onEndOfTurn() {// 1.At the end of your turn.
        ...
        for (AbstractMonster mo : (AbstractDungeon.getCurrRoom()).monsters.monsters)
            AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction((AbstractCreature)mo, AbstractDungeon.player, new WeakPower((AbstractCreature)mo, this.powerAmount, false), this.powerAmount, true, AbstractGameAction.AttackEffect.NONE)); 
        for (AbstractMonster mo : (AbstractDungeon.getCurrRoom()).monsters.monsters)
            AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction((AbstractCreature)mo, AbstractDungeon.player, new VulnerablePower((AbstractCreature)mo, this.powerAmount, false), this.powerAmount, true, AbstractGameAction.AttackEffect.NONE)); 
        AbstractDungeon.actionManager.addToBottom(
