...
public class DEPRECATEDMeatPower extends AbstractEasyPower implements CloneablePowerInterface, NonStackablePower {

    public static final String POWER_ID = makeID("DEPRECATEDMeatPower");
    ...
    public DEPRECATEDMeatPower(AbstractCreature owner) {
...
/*            if (AbstractDungeon.player.currentHealth != this.turnHp)
    ...
    public AbstractPower makeCopy() {
        return new DEPRECATEDMeatPower(this.owner);
    }
}
