...
public class HelpPower extends AbstractEasyPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TexLoader.getTexture(LonelyMod.modID + "Resources/images/powers/Help84.png");
    private static final Texture tex32 = TexLoader.getTexture(LonelyMod.modID + "Resources/images/powers/Help32.png");
