...
public class IOUPower extends AbstractEasyPower implements CloneablePowerInterface {

    public static final String POWER_ID = makeID("IOUPower");
    ...
    public IOUPower(AbstractCreature owner, int amount) {
    ...
    public AbstractPower makeCopy() {
        return new IOUPower(this.owner, this.amount);
    }
}
